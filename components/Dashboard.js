  ...
  return (
    <>
          ...
          <ul class="space-y-2 font-medium">
            ...
            <li>
              <a
                href="/users"
                class={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white  ${
                  pathName == "/users" ? "bg-gray-100 dark:bg-gray-700" : ""
                }  group`}
              >
                <svg
            ...
            <li>
              <a
                href="/signin"
                class={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white  ${
                  pathName == "/signin" ? "bg-gray-100 dark:bg-gray-700" : ""
                }  group`}
              >
                <svg
                  class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
            ...
            <li>
              <a
                href="/signup"
                class={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white  ${
                  pathName == "/signup" ? "bg-gray-100 dark:bg-gray-700" : ""
                }  group`}
              >
                <svg
                  class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
      ...
      {open && (
        <aside
          id="default-sidebar"
          class={`fixed top-0 left-0 z-40 w-64 h-screen transition-transform transform ${
        ...
        >
          <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <div className="flex items-center justify-around space-x-4">
              {" "}
              {/* Added space-x-4 for consistent spacing */}
              ...
              <button
                onClick={() => isOpen(!open)}
                type="button"
                className="inline-flex items-center mb-5   text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
              >
